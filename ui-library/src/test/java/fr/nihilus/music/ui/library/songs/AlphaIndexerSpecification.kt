...
package fr.nihilus.music.ui.library.songs
...
internal class AlphaIndexerSpecification

@RunWith(AndroidJUnit4::class)
internal class WithNoItem {
...
@RunWith(AndroidJUnit4::class)
internal class WithOneItemPerSection : ItemBasedIndexerScenario() {
...
@RunWith(AndroidJUnit4::class)
internal class WithSameFirstLetter : ItemBasedIndexerScenario() {
    override val items = listOf(
        "Another One Bites the Dust",
        "Back in Black",
        "Black Betty",
...
@RunWith(AndroidJUnit4::class)
internal class WithNonLetterItems : ItemBasedIndexerScenario() {
    override val items = listOf(
        "[F]",
        "10 Years Today",
        "Another One Bites The Dust",
...
@RunWith(AndroidJUnit4::class)
internal class WithDiacriticsItems : ItemBasedIndexerScenario() {
    override val items = listOf(
...
@RunWith(AndroidJUnit4::class)
internal class WithLeadingCommonEnglishPrefixes : ItemBasedIndexerScenario() {
    override val items = listOf(
...
@RunWith(AndroidJUnit4::class)
internal class WithUnexpectedItems : ItemBasedIndexerScenario() {
    override val items = listOf(
        "  \nHello World!",
        "This",
        "is",
...
@RunWith(AndroidJUnit4::class)
internal class WithLotsOfItemsPerSection : ItemBasedIndexerScenario() {
    override val items = listOf(
        "Saint Cecilia",
        "Say Goodnight",
        "Scream",
...
@RunWith(AndroidJUnit4::class)
internal class WithLotsOfItemsPerSectionAndSpecialChars : ItemBasedIndexerScenario() {
 ...
 */
internal abstract class ItemBasedIndexerScenario {
    /** The indexer under test, initialized with items. */
    lateinit var indexer: AlphaSectionIndexer
     ...
     */
    fun assertSectionStartsAtPosition(sectionIndex: Int, expectedItemPosition: Int) {
     ...
     * printing a cleaner error message when the assertion fails.
     */
    fun assertItemInSection(itemPosition: Int, expectedSectionIndex: Int) {
